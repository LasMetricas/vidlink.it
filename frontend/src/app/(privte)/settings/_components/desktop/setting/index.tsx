...
const Index: React.FC<Type> = ({
  ...
  return (
    <>
      <main className="mt-[118px]  w-screen px-[80px] tracking-wider">
        <EditPic
          setEdit={setEdit}
          setImgUrl={setImgUrl}
        ...
        <div className="flex justify-between gap-10 items-start">
          <div className="flex flex-col gap-[17px] justify-between flex-1">
            ...
            <div className="flex flex-col ga">
              <UserName
                ...
                userName={userName}
              />
              <i className="text-[red] text-[16px]">
                {caution ? <h1 className="mt-1">{caution}</h1> : null}
              </i>
            </div>
          ...
          <div className="h-[314.15px] flex flex-col gap-[17.2px] mb-[160px] flex-1">
            <h1 className="text-[18px] font-semibold  flex items-center gap-[17px] justify-center">
              LINKS{" "}
              <img className="size-4" src="/icon/settings/link.png" alt="" />
            </h1>
            <LinkItem
