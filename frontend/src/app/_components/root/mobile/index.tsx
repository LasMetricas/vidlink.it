...
function VideoCard({ video, isActive, isAuth }: VideoCardProps) {
  ...
  return (
    <div className="h-screen w-full snap-start relative bg-black overflow-hidden">
        ...
        <div className="absolute bottom-[160px] left-4 z-30 animate-in fade-in slide-in-from-left-4 duration-300">
          <div className="relative">
            ...
            <a
              ...
              className="block w-[120px] h-[120px] min-w-[120px] min-h-[120px] flex-shrink-0 bg-gradient-to-br from-blue to-blue/70 rounded-[16px] p-3 flex flex-col justify-between shadow-lg no-underline"
            >
      ...
      {/* Side Actions */}
      <div className="absolute right-3 bottom-[180px] flex flex-col gap-6 z-20">
        {/* Mute/Unmute Button */}
        <button
        ...
        >
          ...
          <span className="text-[11px] mt-1.5">{isMuted ? "Unmute" : "Mute"}</span>
        </button>
        <Link
        ...
        >
          <div className="w-14 h-14 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-sm">
            <span className="text-[14px] font-bold">{video.card}</span>
          </div>
          <span className="text-[11px] mt-1.5">Cards</span>
        </Link>
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-sm">
            <span className="text-[14px] font-bold">{video.views}</span>
          </div>
          <span className="text-[11px] mt-1.5">Views</span>
        </div>
      </div>
